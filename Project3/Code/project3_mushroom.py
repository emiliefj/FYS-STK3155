...
if __name__ == '__main__':
    ...
    full_tree=dt.build_and_test_tree(X_train,y_train,X_val,y_val, max_depth=max_depth, max_leaf_nodes=max_leaf_nodes, random=random, name="mushroom", print_tree=False, feature_names=features)
    ...
    # Own Adaptive Boosting code
    y_pred = ab.predict(X_test)
    print(f"\nAdaptive boosting code on mushroom dataset with max_depth = {max_depth} and max_leaf_nodes = {max_leaf_nodes} on test set:")
